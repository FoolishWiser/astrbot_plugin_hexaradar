...
- **编辑**：点击卡片或列表「编辑」按钮，拖拽滑块实时预览综合分
- **新建**：点击「+ 新建人员」，默认六项 60 分
- **删除**：编辑弹窗或列表中的「删除」按钮（需确认）
...
| `set_radar_scores(name, learning, psychology, social, judgment, self_awareness, direction, desc?)` | 新建或更新人员评分（upsert） |
